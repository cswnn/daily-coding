...
<table>
  ...
  <tbody>
    ...
    <!-- Heap 섹션                           ============================== --> 
    <tr>
      <td rowspan="2"><b>Heap</b></td>
      <td>더 맵게</td>
      <td>Level 2</td>
      <td><a href="프로그래머스/2/42626. 더 맵게/더 맵게.py">보러가기</a></td>
    </tr>
    <tr>
      <td>예시</td>
      <td>Level 2</td>
  ...
  <!-- 이분탐색(Binary Search) 섹션             ============================== --> 
    <tr>
      <td rowspan="2"><b>Binary Search</b></td>
      <td>예시</td>
      <td>Level 1</td>
      <td><a href="여기에_링크_붙여넣기">보러가기</a></td>
    </tr>
